...
#define MM_PER_COUNT 534000  // for TDR-SR1000 100 counts, 170mm diameter// 787990  // 3171909  // actually 1/10^6mm per count since we divide by usecs
...
//}
  ...
  tft.setCursor(0,32);
  #ifdef CYLINDER_6IN
  tft.print("6.06\" Cylinder");
  tft.setCursor(0,64);
  tft.print("2048 cpr");
  #else
  tft.print("Belt Treadmill");
  #endif
  delay(2000);
